...
7. **Git Hooks 集成**：集成 husky 和 lint-staged，提供 pre-commit 和 commit-msg 钩子。
...
| `lint-staged` | ^15.2.10   | Git 暂存区文件检查工具                    |
...
│   ├── .lintstagedrc.ejs     # lint-staged 配置模板
│   ├── .npmrc.ejs            # npm 配置模板
│   ├── .eslintignore.ejs     # ESLint 忽略文件模板
